...
Start-Process powershell -ArgumentList "-NoExit -Command `"Set-Location '$projectRoot\Backend'; Write-Host '--- DÉMARRAGE BACKEND SPRING BOOT ---' -ForegroundColor Cyan; mvn spring-boot:run`""
