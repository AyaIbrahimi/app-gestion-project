...
public class ReportingController {
    ...
    public ResponseEntity<List<UserReportDto>> getUsersWithoutProfile() {
    ...
    public ResponseEntity<List<ProjectSelectDto>> getProjectsForSelect() {
    ...
    public ResponseEntity<List<TeamSelectDto>> getTeamsForSelect() {
    ...
    public ResponseEntity<byte[]> exportUsersNoProfileExcel() {
        List<UserReportDto> data = reportingService.getUsersWithoutProfile();
