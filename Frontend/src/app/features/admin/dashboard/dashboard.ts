...
export class Dashboard implements OnInit {
  ...
  kpiData = computed(() => [
    { title: 'TOTAL', value: this.totalUsers().toString(), icon: 'users' },
    { title: 'ACTIFS', value: this.activeUsers().toString(), icon: 'active' },
    { title: 'INACTIFS', value: this.inactiveUsers().toString(), icon: 'inactive' },
    { title: 'TAUX VALIDATION', value: '94.2%', icon: 'check' },
    { title: 'TAUX REJET', value: '5.8%', icon: 'cross' },
